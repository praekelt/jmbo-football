...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('football_league_group', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('football_league_group')
    ...
    models = {
        ...
        'football.fixture': {
            'Meta': {'object_name': 'Fixture', 'db_table': "'football_fixture'"},
        ...
        'football.league': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'League', 'db_table': "'football_league'", '_ormbases': ['jmbo.ModelBase']},
        ...
        'football.leaguegroup': {
            'Meta': {'object_name': 'LeagueGroup', 'db_table': "'football_league_group'"},
            'football365_ci': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'football365_di': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'football.logentry': {
            'Meta': {'unique_together': "(('league', 'team'),)", 'object_name': 'LogEntry', 'db_table': "'football_logentry'"},
        ...
        'football.player': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Player', 'db_table': "'football_player'", '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}),
            'teams': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['football.Team']", 'symmetrical': 'False'})
        },
        'football.team': {
            'Meta': {'ordering': "('title',)", 'object_name': 'Team', 'db_table': "'football_team'", '_ormbases': ['jmbo.ModelBase']},
        ...
        'football.trivia': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Trivia', 'db_table': "'football_trivia'", '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'jmbo.modelbase': {
