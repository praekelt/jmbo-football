...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.abbreviated_title'
        db.add_column('football_team', 'abbreviated_title',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.abbreviated_title'
    ...
    models = {
        ...
        'football.team': {
            ...
            'abbreviated_title': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
